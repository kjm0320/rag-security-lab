...
프로젝트 실험을 OWASP LLM Top 10 2025의
LLM01·LLM02·LLM05·LLM07·LLM08과 연결해 정리했습니다.
각 위험의 일부만 검증했으며 공식 인증이나 전체 대응 완료를 의미하지 않습니다.

[OWASP 분류별 구현·실험·미검증 범위](docs/owasp-mapping.md)
...
- OWASP 대응 관계에서 확인한 미검증 범위의 실험 확장
- 종합 점수 산식 및 타당성 검증 미구현
